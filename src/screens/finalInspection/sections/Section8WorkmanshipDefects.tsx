...
const SYSTEM_DEFECT_CONTENTS = [
  'INCORRECT SIZE LABELS', 'MISSING SIZE LABELS', 'INCORRECT COUNTRY OF ORIGIN', 'MISSING COUNTRY OF ORIGIN',
  'INCORRECT PLACEMENT OF LABEL', 'INCORRECT CONTENT ON CARE LABEL', 'INCORRECT CARE LABEL', 'INCORRECT BARCODE',
  'INCORRECT SWING TICKET', 'INCORRECT DISCLAIMER TAG', 'MISSING BARCODES', 'MISSING SWING TICKETS',
  'MISSING DISCLAIMER', 'INCORRECT CITES LABEL', 'INCORRECT NON-CITES LABEL', 'MISSING CITES LABEL',
  'MISSING NON-CITES LABEL', 'INCORRECT MID NUMBER', 'MISSING MID NUMBER', 'ILLEGIBLE PRINTING',
  'INCORRECT QC STICKER', 'MISSING QC STICKER', 'INCORRECT BRANDING LABEL POSITION', 'WAVY BRANDING LABEL',
  'INCORRECT BRANDING', 'ILLEGIBLE BRANDING',
].map(t => ({ label: t, value: t }));
